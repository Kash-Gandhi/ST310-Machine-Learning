...
gapm_2002_scatter + 
  geom_line(data = lm_2002_predictions, 
            aes(y = .fitted),
            linetype = "dashed") + 
  geom_line(data = loess_2002_predictions,
            aes(y = .fitted))
```
...
````{r}
lm_2007_predictions <- augment(lm_2002, newdata = gapm_2007)
loess_2007_predictions <- augment(loess_2002, newdata = gapm_2007)

ggplot(gapm_2007, 
       aes(x = gdpPercap, y = lifeExp)) + 
  geom_point() + 
  geom_line(data = lm_2007_predictions, 
            aes(y = .fitted), 
            color = "red", 
            linetype = "dashed") + 
  geom_line(data = loess_2007_predictions, 
            aes(y = .fitted), 
            color = "red")
...
```{r}
mean(lm_1997_predictions$residuals **2)
mean(loess_1997_predictions$resideuals **2)

mean(lm_2007_predictions$residuals **2)
mean(loess_2007_predictions$resideuals **2, na.rm = TRUE)
```
